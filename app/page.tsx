...
export default async function HomePage() {
  ...
  const n2 = [1, 4, 9, 16, 25, 36, 49, 64, 81, 100, 121, 144, 169, 196, 225, 256, 289, 324, 361, 400]
  const log2N = [0, 1, 1.5849625007211563, 2, 2.321928094887362, 2.584962500721156, 2.807354922057604, 3, 3.169925001442312, 3.321928094887362, 3.4594316186372978, 3.5849625007211565, 3.700439718141092, 3.807354922057604, 3.9068905956085187, 4, 4.08746284125034, 4.169925001442312, 4.247927513443585, 4.321928094887363]

  const expN = [2.718281828459045, 7.3890560989306495, 20.085536923187668, 54.598150033144236, 148.4131591025766, 403.4287934927351, 1096.6331584284585, 2980.9579870417283, 8103.083927575384, 22026.465794806718, 59874.14171519782, 162754.79141900392, 442413.3920089205, 1202604.2841647768, 3269017.3724721107, 8886110.520507872, 24154952.7535753, 65659969.13733051, 178482300.96318725, 485165195.4097903]
...
function generateExpArray(n: number) {
  const expArray = [];
  for (let i = 1; i <= n; i++) {
